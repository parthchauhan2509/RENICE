  ...
  {    
      ...
      int result = NO_SUCH_PAGE;    
        ...
        try{
            ...
            g2d.drawString("         Renice.com        ",12,y);y+=yShift;
            g2d.drawString("   No 00000 Address Line One ",12,y);y+=yShift;
            g2d.drawString("   Address Line 02 India ",12,y);y+=yShift;
            g2d.drawString("   www.facebook.com/Renice ",12,y);y+=yShift;
            g2d.drawString("        +1234567890      ",12,y);y+=yShift;
            ...
            g2d.drawString("*************",10,y);y+=yShift;
            g2d.drawString("       SOFTWARE BY:Renice          ",10,y);y+=yShift;
            g2d.drawString("   CONTACT: contact@bennett.edu.India       ",10,y);y+=yShift;       
